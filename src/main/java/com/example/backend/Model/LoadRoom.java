...
public class LoadRoom {
	...
	public LoadRoom() {
    	 ...
    	 */
    	Room room1 = new Room("Handlery Union Square Hotel", 
    						...
    						8.3, "Double Room with Two Double Beds", 319, false);
    	rooms.add(room1);
    	
    	room1 = new Room("Greenwich Inn",
    					...
    					8, "Premium Two Full Beds", 159, false);
    	rooms.add(room1);
    	
    	room1 = new Room("Club Quarters Hotel Embarcadero, San Francisco",
    					...
    					8.2, "Superior Queen Room", 249, false);
    	rooms.add(room1);
    	
    	room1 = new Room("Hampton Inn San Francisco Downtown/Convention Center",
    					...
    					7.9, "Deluxe King Room with Sofa Bed", 339, false);
    	rooms.add(room1);
    	
    	room1 = new Room("Riu Plaza Fisherman's Wharf", 
    					...
    					8.1, "Deluxe Queen Room with Two Queen Beds", 329, false);
    	rooms.add(room1);
